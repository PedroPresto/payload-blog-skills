...
// Substitua {{SITE_NAME}} pelo identificador do projeto (vira a pasta no Cloudinary).
const CLOUDINARY_FOLDER = "{{SITE_NAME}}";
...
export const Media: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      name: "cloudinaryUrl",
      type: "text",
      admin: { readOnly: true, description: "Automatically generated by Cloudinary" },
    },
  ],
};
